...
A Certified Network Engineer with extensive experience in designing, implementing, and maintaining robust network infrastructures, currently focused on advancing expertise in enterprise routing and cloud operations. Proven ability in troubleshooting complex network issues, optimizing performance, and integrating modern cloud technologies.

Core Competencies
	Networking: 
	
		Network Design & Implementation (LAN, WAN, WLAN, VoIP, VPN), Routing & Switching (Cisco, Juniper, Huawei), Network Security (Firewalls, VPNs), Troubleshooting & Performance Optimization.
